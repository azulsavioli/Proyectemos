...
class RecordAudioArtistasProviderImpl extends ChangeNotifier
  ...
  bool _isRecorderOpen = false; // Variável de controle adicionada
  ...
  Future<void> recordVoice(context) async {
    try {
      ...
      if (!_isRecorderOpen) { // Corrigido: usando _isRecorderOpen
        await _record.openRecorder();
        _isRecorderOpen = true; // Atualizando a variável de controle
      }
  ...
  Future<void> disposeRecorder() async {
    ...
    if (_isRecorderOpen) { // Corrigido: usando _isRecorderOpen
      ...
      _isRecorderOpen = false; // Atualizando a variável de controle
    }
  }
}
