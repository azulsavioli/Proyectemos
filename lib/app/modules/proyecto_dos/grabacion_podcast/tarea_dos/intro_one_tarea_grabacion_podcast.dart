...
class IntroUnoTareaDosGrabacionPodcastPage extends StatefulWidget {
  final TareaDosGrabacionPodcastController controller;
  const IntroUnoTareaDosGrabacionPodcastPage({
    Key? key,
    required this.controller,
  }) : super(key: key);

  @override
  State<IntroUnoTareaDosGrabacionPodcastPage> createState() =>
      _IntroUnoTareaDosGrabacionPodcastPageState();
}

class _IntroUnoTareaDosGrabacionPodcastPageState
    extends State<IntroUnoTareaDosGrabacionPodcastPage>
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              StringsGrabacionPodcast.descriptionUnoTareaDosGrabacionPodcast,
            ...
            FutureBuilder<List<String>?>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  // Usa _currentUser carregado antes, sem await
                  for (final name in names) {
