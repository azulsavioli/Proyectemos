...
class IntroTareaUnoGrabacionPodcastPage extends StatefulWidget {
  final GrabacionPodcastController controller;
  const IntroTareaUnoGrabacionPodcastPage({
    Key? key,
    required this.controller,
  }) : super(key: key);

  @override
  State<IntroTareaUnoGrabacionPodcastPage> createState() =>
      _IntroTareaUnoGrabacionPodcastPageState();
}

class _IntroTareaUnoGrabacionPodcastPageState
    extends State<IntroTareaUnoGrabacionPodcastPage>
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              StringsGrabacionPodcast.descriptionUnoTareaUnoGrabacionPodcast,
