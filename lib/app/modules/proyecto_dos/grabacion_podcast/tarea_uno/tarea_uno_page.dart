...
import 'tarea_grabacion_podcast.dart';
import 'tarea_uno_controller.dart';

class TareaUnoGrabacionPodcast extends StatefulWidget {
  const TareaUnoGrabacionPodcast({Key? key}) : super(key: key);

  @override
  State<TareaUnoGrabacionPodcast> createState() =>
      _TareaUnoGrabacionPodcastState();
}

class _TareaUnoGrabacionPodcastState extends State<TareaUnoGrabacionPodcast> {
  final _controller = GrabacionPodcastController();
  bool loading = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          StringsGrabacionPodcast.titleTareaUnoGrabacionPodcast,
      ...
      body: PageView(
        ...
        children: [
          IntroTareaUnoGrabacionPodcastPage(
            controller: _controller,
          ),
          const IntroTareaDosGrabacionPodcastPage(),
          TareaUnoGrabacionPodcastPage(
            controller: _controller,
          ),
        ],
      ),
