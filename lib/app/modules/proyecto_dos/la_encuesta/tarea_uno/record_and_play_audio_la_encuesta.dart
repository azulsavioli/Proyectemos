...
class RecordAndPlayLaEncuestaTareaUnoScreen extends StatefulWidget {
  const RecordAndPlayLaEncuestaTareaUnoScreen({Key? key}) : super(key: key);

  @override
  State<RecordAndPlayLaEncuestaTareaUnoScreen> createState() =>
      _RecordAndPlayLaEncuestaTareaUnoScreenState();
}

class _RecordAndPlayLaEncuestaTareaUnoScreenState
    extends State<RecordAndPlayLaEncuestaTareaUnoScreen> {
  ...
  Widget build(BuildContext context) {
    final recordProvider =
        Provider.of<RecordAudioLaEncuestaTareaUnoProviderImpl>(context);
  ...
  InkWell _recordingSection() {
    ...
    final recordProviderWithoutListener =
        Provider.of<RecordAudioLaEncuestaTareaUnoProviderImpl>(
      context,
      listen: false,
    );
