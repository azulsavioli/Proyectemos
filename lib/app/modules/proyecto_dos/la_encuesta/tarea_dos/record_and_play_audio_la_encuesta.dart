...
class RecordAndPlayLaEncuestaTareaDosScreen extends StatefulWidget {
  const RecordAndPlayLaEncuestaTareaDosScreen({Key? key}) : super(key: key);

  @override
  State<RecordAndPlayLaEncuestaTareaDosScreen> createState() =>
      _RecordAndPlayLaEncuestaTareaDosScreenState();
}

class _RecordAndPlayLaEncuestaTareaDosScreenState
    extends State<RecordAndPlayLaEncuestaTareaDosScreen> {
  ...
  Widget build(BuildContext context) {
    final recordProvider =
        Provider.of<RecordAudioLaEncuestaTareaDosProviderImpl>(context);
  ...
  InkWell _recordingSection() {
    ...
    final recordProviderWithoutListener =
        Provider.of<RecordAudioLaEncuestaTareaDosProviderImpl>(
      context,
      listen: false,
    );
