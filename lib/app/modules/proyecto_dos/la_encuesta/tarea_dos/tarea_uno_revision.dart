...
class RevisionQuestionsComoCrearUnaEncuesta extends StatefulWidget {
  final List<TextEditingController> controllerList;

  const RevisionQuestionsComoCrearUnaEncuesta({
    Key? key,
    required this.controllerList,
  }) : super(key: key);

  @override
  State<RevisionQuestionsComoCrearUnaEncuesta> createState() =>
      _RevisionQuestionsComoCrearUnaEncuestaState();
}

class _RevisionQuestionsComoCrearUnaEncuestaState
    extends State<RevisionQuestionsComoCrearUnaEncuesta> {
