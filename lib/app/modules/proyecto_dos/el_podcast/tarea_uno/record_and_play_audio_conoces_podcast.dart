...
class RecordAndPlayConocesPodcastScreen extends StatefulWidget {
  const RecordAndPlayConocesPodcastScreen({Key? key}) : super(key: key);

  @override
  State<RecordAndPlayConocesPodcastScreen> createState() =>
      _RecordAndPlayConocesPodcastScreenState();
}

class _RecordAndPlayConocesPodcastScreenState
    extends State<RecordAndPlayConocesPodcastScreen> {
  ...
  Widget build(BuildContext context) {
    final recordProvider =
        Provider.of<RecordAudioConocesPodcastProviderImpl>(context);
  ...
  InkWell _recordingSection() {
    ...
    final recordProviderWithoutListener =
        Provider.of<RecordAudioConocesPodcastProviderImpl>(
      context,
      listen: false,
    );
  ...
  InkWell _resetButton() {
    final recordProvider = Provider.of<RecordAudioConocesPodcastProviderImpl>(
      context,
      listen: false,
    );
