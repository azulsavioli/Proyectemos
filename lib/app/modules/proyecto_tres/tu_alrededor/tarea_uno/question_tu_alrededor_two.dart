...
class QuestionTuAlrededorTwo extends StatefulWidget {
  ...
  const QuestionTuAlrededorTwo({
    Key? key,
    required this.controller,
  }) : super(key: key);

  @override
  State<QuestionTuAlrededorTwo> createState() => _QuestionTuAlrededorTwoState();
}

class _QuestionTuAlrededorTwoState extends State<QuestionTuAlrededorTwo>
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            StringsTuAlrededor.qDosTuAlrededor,
            style: ThemeText.paragraph16GrayNormal,
          ),
          CustomRecordAudioButton(
            question: StringsTuAlrededor.qDosTuAlrededor,
