...
class RecordAndPlayLaSociedad extends StatefulWidget {
  ...
  @override
  State<RecordAndPlayLaSociedad> createState() =>
      _RecordAndPlayLaSociedadState();
}

class _RecordAndPlayLaSociedadState extends State<RecordAndPlayLaSociedad> {
  ...
  Widget build(BuildContext context) {
    final recordProvider =
        Provider.of<RecordAudioLaSociedadProviderImpl>(context);
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            ...
            fit: BoxFit.cover,
            image: NetworkImage(
              Strings.laSociedadGrabacionImage,
            ),
          ),
        ),
        child: Column(
  ...
  InkWell _recordingSection() {
    ...
    final recordProviderWithoutListener =
        Provider.of<RecordAudioLaSociedadProviderImpl>(
      context,
      listen: false,
    );
  ...
  InkWell _resetButton() {
    final recordProvider = Provider.of<RecordAudioLaSociedadProviderImpl>(
      context,
      listen: false,
    );
